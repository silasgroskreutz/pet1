...
const Authenticate = App => LoginPage => {
  return class extends React.Component {
    ...
    handleLogin = event => {
      ...
      axios
        .post(
          'https://pet-pantry-backend.herokuapp.com/api/staff/login',
          loginObj
        )
        .then(response => {
    ...
    handleRegister = event => {
      ...
      axios
        .post(
          'https://pet-pantry-backend.herokuapp.com/api/staff/register',
          registerObj
        )
        .then(response => {
    ...
    render() {
      if (this.state.loggedIn) {
        return <App handleTokenExpired={this.handleTokenExpired} />;
      } else {
        return (
          <div>
            <LoginPage
            ...
            />
            <div
              style={{ backgroundColor: '#7F0000', opacity: 0.8 }}
              id='snackbar'
              ref={this.snackbar}
            >
